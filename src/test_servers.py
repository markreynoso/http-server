...
def test_put_request_error():
    ...
    assert response == 'HTTP/1.1 405 Internal server error\n<CRLF>\n'
...
def test_invalid_protocol():
    ...
    assert response == 'HTTP/1.1 400 Internal server error\n<CRLF>\n'
...
def test_header_not_exist():
    ...
    assert response == 'HTTP/1.1 406 Internal server error\n<CRLF>\n'
